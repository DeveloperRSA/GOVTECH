...
const StatCard = ({ title, value, icon }: StatCardProps) => (
  <View style={localStatCardStyles.card}>
    ...
    <Text style={localStatCardStyles.title} numberOfLines={1}>
      {title}
    </Text>
  </View>
);
...
export default function OrganisationDashboardScreen() {
  ...
  const loadDashboard = useCallback(
    async (showRefresh = false) => {
      ...
      try {
        ...
        setMembership(
          currentMembership as Membership
        );
  ...
  const getOrganisationTypeLabel =
    (type?: string) => {
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text
                style={
                  styles.dashboardHeaderSubtitle
                }
              >
                Organisation Portal
              </Text>
          ...
          >
            ...
            >
              ...
              >
                Your organisation workspace is currently connected to CIVITRACK.
              </Text>
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  >
                    Manage your organisation's staff, collaborators and workspace access.
                  </Text>
